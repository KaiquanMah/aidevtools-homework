...
* Think of a problem that's interesting for you
  * 2025.12.28 Kai
    * Problem: As an English speaker and beginner to the Finnish language, I want an easy and engaging way to learn and practise my Finnish language skills. This helps me learn and read things in the Finnish language, or if I am visiting Finland, I can understand and communicate easily with locals.
    * Expected Output: Website to learn the written and verbal forms of the Finnish language, from level 0 to A2.2 basic level.
    * Information about levels (Sources: https://www.kielibuusti.fi/en/learn-finnish/language-tests-and-integration/language-skill-levels-a1-c2, https://www.infofinland.fi/en/finnish-and-swedish/finnish-online)
    ```
    Starting level 0  
...
* Create the frontend, backend and describe their communication with API specs
    * You can do it in any order:
        * Specs first - 2025.12.28 please use this approach
        * Frontend first, like shown in the course
        * Backend first
        * But all 3 (specs, frontend, backend) have to be done
